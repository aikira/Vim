" My colorscheme optimized for MacVim and gVim
" Maintainer: Philipp Rumschinski
" Version: 0.1
...
" My color settings (optimized for Latex in MacVim/gVim)
" ------------------------------------------------------------------------
" Normal
" ------------------------------------------------------------------------
" * Normal (text and background)
hi Normal          cterm=none  ctermfg=231    ctermbg=237
                 \ gui=none    guifg=#eeeeee  guibg=#3f3a3b
" Comments
hi Comment         cterm=none  ctermfg=108    ctermbg=237
                 \ gui=none    guifg=#87af87  guibg=#3f3a3b
" * Constant (any constant (e.g. String, Character Number Boolean Float))
hi Constant        cterm=none  ctermfg=108    ctermbg=237
                 \ gui=none    guifg=#87af87  guibg=#3f3a3b
hi Number          cterm=none  ctermfg=148    ctermbg=237
                 \ gui=none    guifg=#5fafff  guibg=#3f3a3b
hi Boolean         cterm=none  ctermfg=148    ctermbg=237
                 \ gui=none    guifg=#5fafff  guibg=#3f3a3b
" * Identifier (any variable name (e.g. Function))
hi Identifier      cterm=bold  ctermfg=187    ctermbg=237
                 \ gui=bold    guifg=#dfdfaf  guibg=#3f3a3b
" * Statement (any statement (e.g. Conditional, Repeat, Label, Operator, Keyword, Exception))
hi Statement       cterm=bold  ctermfg=187    ctermbg=237
                 \ gui=bold    guifg=#dfdfaf  guibg=#3f3a3b
" * PreProc (generic preprocessor (e.g. Include, Define, Macro, PreCondit))
hi PreProc         cterm=bold  ctermfg=187    ctermbg=237
                 \ gui=bold    guifg=#dfdfaf  guibg=#3f3a3b
" Type (int, long, char, etc. (e.g. StorageClass, Structure, Typedef))
hi Type            cterm=bold  ctermfg=187    ctermbg=237
                 \ gui=bold    guifg=#dfdfaf  guibg=#3f3a3b
" * Special any special symbol (e.g. SpecialChar, Tag, Delimiter, SpecialComment, Debug)
hi Special         cterm=bold  ctermfg=245    ctermbg=237
                 \ gui=bold    guifg=#8a8a8a  guibg=#3f3a3b
" * TODO (keywords that need attention (e.g. TODO, FIXME, XXX))
hi Todo            cterm=bold  ctermfg=148    ctermbg=237
                 \ gui=bold    guifg=#b9e216  guibg=#3f3a3b
" Line number
hi LineNr          cterm=none  ctermfg=245    ctermbg=237
                 \ gui=none    guifg=#8a8a8a  guibg=#3f3a3b
" Menu zone
hi WildMenu        cterm=bold  ctermfg=231    ctermbg=16
                 \ gui=bold    guifg=#ffffff  guibg=#000000
" White-spaces
hi RedundantSpaces cterm=none  ctermfg=148    ctermbg=17
                 \ gui=none    guifg=#ff005f  guibg=#5d89a4
match RedundantSpaces /\s\+$\| \+\ze\t/
hi ExtraWhitespace cterm=none  ctermfg=148    ctermbg=17
                 \ gui=none    guifg=#ff005f  guibg=#5d89a4
" Spelling mistakes
hi SpellBad        cterm=none  ctermfg=160  ctermbg=238
                 \ gui=undercurl guisp=#ff0066
hi SpellCap        cterm=bold  ctermfg=17   ctermbg=237
                 \ gui=undercurl guisp=#66bbee
" ------------------------------------------------------------------------
" Latex zone
" ------------------------------------------------------------------------
hi texMath         cterm=none  ctermfg=75     ctermbg=237
                 \ gui=none    guifg=#5fafff  guibg=#3f3a3b
hi texSuperscript  cterm=none  ctermfg=75     ctermbg=237
                 \ gui=none    guifg=#5fafff  guibg=#3f3a3b
hi texSubscript    cterm=none  ctermfg=75     ctermbg=237
                 \ gui=none    guifg=#5fafff  guibg=#3f3a3b
hi texSuperscripts cterm=none  ctermfg=75     ctermbg=237
                 \ gui=none    guifg=#5fafff  guibg=#3f3a3b
hi texSubscripts   cterm=none  ctermfg=75     ctermbg=237
                 \ gui=none    guifg=#5fafff  guibg=#3f3a3b
hi texMyLabel      cterm=none  ctermfg=132    ctermbg=237
                 \ gui=none    guifg=#af5f87  guibg=#3f3a3b
hi texRefZone      cterm=none  ctermfg=132    ctermbg=237
                 \ gui=none    guifg=#af5f87  guibg=#3f3a3b
" ------------------------------------------------------------------------
" VIM Zone
" ------------------------------------------------------------------------
hi vimIsCommand    cterm=bold  ctermfg=187    ctermbg=237
                 \ gui=bold    guifg=#dfdfaf  guibg=#3f3a3b

hi Search          cterm=none  ctermfg=231    ctermbg=29
                 \ gui=none    guifg=#eeeeee  guibg=#00875f
" ------------------------------------------------------------------------
" Color chart (for choosing colors easier use hexHighlighting.vim in gvim)
" ------------------------------------------------------------------------
